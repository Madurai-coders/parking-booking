...
export function axios_call_unauthenticated(method, url, data) {
  return new Promise(function (resolve, reject) {
    axios({
      method: method,
      url: "https://parkingdev.munidex.info:8000/" + url,
      data: data,
    }).then((response) => {
  ...
  return new Promise(function (resolve, reject) {
    ...
    axios({
      ...
      .catch((response) => {
        ...
        axios({
          method: "POST",
          url: "https://parkingdev.munidex.info:8000/api/token/refresh/",
      ...
      .then((data) => {
        ...
        if (data.additionalUserInfo.isNewUser) {
          axios({
            ...
            axios({
              method: "POST",
              url: "https://parkingdev.munidex.info:8000/api/jwt_token/",
              data: {
                username: data.user.email,
                password: data.user.uid,
              },
