...
export default function Bookinginvoice(props) {
  ...
  return (
    <>
      <div onClick={props.ClosePreview} className="bookinginvoice_container flex-grow-1 px-3 pt-1 mb-3 shadow">
        <div className="bookinginvoice_topsection row">
          <div className="col-8"></div>
          <div className="col-4">
          <div className="bookinginvoice_text_binv mb-3">Booking Invoice</div>
          <div className="bookinginvoice_text_invno mb-1">Invoice no: {props.bookingData.bookingId}</div>
          <div className="bookinginvoice_text_invdate">Invoice Date: {props.bookingData.date}</div>
          </div>  
        </div>
        <div className="bookinginvoicebody">
            <div>
          <div className="bookinginvoice_text_billto mt-4 mb-2">Bill To :</div>
          <div className="bookinginvoice_text_address mb-4 px-4">{props.bookingData.User.userName}</div>
        ...
        <div className="bookinginvoice_total">{props.bookingData.charge}$</div>
        </div>
        <div>
        <div className="row">
         <div className="col-6">
        ...
        <div className="bookinginvoice_dop"> Payment Type: <span className="bookinginvoice_dop_value">Upi </span></div> */}
         ...
         <div className="col-6 pb-5">
          ...
          <div className="row">
           <div className="col-6 bookinginvoice_dop"> From: <span className="bookinginvoice_dop_value">{props.bookingData.startFrom} </span></div>
           <div className="col-6 bookinginvoice_dop"> To: <span className="bookinginvoice_dop_value">{props.bookingData.endTo}</span></div>
          </div>
         </div>
        </div>
        <div className="row bookinginvoice_bottom p-2 mb-1"> <div className="col-1 bookinginvoice_bottomtext_terms"> Terms: </div> <div className="col-11 bookinginvoice_bottom_terms">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ornare placerat condimentum venenatis diam ipsum urna, arcu nibh elit.</div> </div>
        </div>
        </div>
      </div>
    </>
