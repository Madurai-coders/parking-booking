      ...
      <div className="user_dashboard_container">
          ...
          <div className="row user_dashboard_popup_section shadow">
                  <div className="col-4 user_dashboard_popup_leftside text-center">
                    < img src={handshake} alt="zengov" className="user_dashboard_handshake_image"/>
                    <div className="user_dashboard_popup_leftside_text">Zen<span>Gov</span></div>
                  </div>
                  <div className="col-8">
                     <div className="user_dashboard_popup_history_container">
                         <div className="user_dashboard_popup_transaction_history_flex">
                             <div className="user_dashboard_popup_transaction_history mb-5"> Transaction History </div>
                             <div className="user_dashboard-popup_close" onClick={()=>(setPopup(false))}><IoClose style={{color: "#646262"}} size={30}/></div>
                        </div> 
                         <div className="row">
                             <div className="col-3">
                                 <div className="user_dashboard_popup_title"> Transaction id</div>
                                 <div className="user_dashboard_popup_tid_text"> 567362925 </div>
                                 <div className="user_dashboard_popup_tid_text"> 567362925 </div>
                                 <div className="user_dashboard_popup_tid_text"> 567362925 </div>
                                 <div className="user_dashboard_popup_tid_text"> 567362925 </div>
                                 <div className="user_dashboard_popup_tid_text"> 567362925 </div>
                             ...
                             <div className="col-3 text-center">
                                 <div className="user_dashboard_popup_title"> Date of Payment </div>
                                 <div className="user_dashboard_popup_dop_text"> 20/11/21 </div>
                                 <div className="user_dashboard_popup_dop_text"> 10/10/21 </div>
                                 <div className="user_dashboard_popup_dop_text"> 10/08/21 </div>
                                 <div className="user_dashboard_popup_dop_text"> 12/09/21 </div>
                                 <div className="user_dashboard_popup_dop_text"> 09/07/21 </div>
                                 <div className="user_dashboard_popup_dop_text"> 18/12/20 </div>
                                 <div className="user_dashboard_popup_dop_text"> 15/10/20 </div>
                                 <div className="user_dashboard_popup_dop_text"> 17/02/19 </div>
                                 <div className="user_dashboard_popup_dop_text"> 22/07/18 </div>
                             </div>
                             <div className="col-3 text-center">
                                 <div className="user_dashboard_popup_title"> Payment </div>
                                 <div className="user_dashboard_popup_payment_text"> $1000 </div>
                                 <div className="user_dashboard_popup_payment_text"> $1043 </div>
                                 <div className="user_dashboard_popup_payment_text"> $2095 </div>
                                 <div className="user_dashboard_popup_payment_text"> $1043 </div>
                                 <div className="user_dashboard_popup_payment_text"> $1246 </div>
                                 <div className="user_dashboard_popup_payment_text"> $1043 </div>
                                 <div className="user_dashboard_popup_payment_text"> $1043 </div>
                                 <div className="user_dashboard_popup_payment_text"> $1043 </div>
                                 <div className="user_dashboard_popup_payment_text"> $1043 </div>                       
                             ...
                             <div className="col-3">
                                 ...
                                 <div className="user_dashboard_popup_status_yellow"> Pending </div>
                                 <div className="user_dashboard_popup_status_green"> Successful </div>
                                 <div className="user_dashboard_popup_status_green"> Successful </div>
                                 <div className="user_dashboard_popup_status_green"> Successful </div>
                                 <div className="user_dashboard_popup_status_green"> Successful </div>
                                 <div className="user_dashboard_popup_status_green"> Successful </div>
          ...
          <div className="col-5">
            <div className="user_dashboard_right_container">
              <div className="user_dashboard_balance_card">
                ...
                <div className="user_dashboard_balance_card_amount">
                  {" "}
                  $ 650{" "}
                </div>
              </div>
              <div className="user_dashboard_transaction_card">
                ...
                <div  className="user_dashboard_transaction_card_seemore text-center mt-4"  onClick={()=>(setPopup(true))}>
                  See more
                </div>
              </div>
            </div>
        ...
        <div className="row">
          ...
          <div className="col-5">
            <div className="user_dashboard_pay_container text-center mt-3">
